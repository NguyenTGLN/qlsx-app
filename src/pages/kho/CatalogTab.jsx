...
export default function CatalogTab({ perms = { catalog: true, del: true } }) {
  // const PAGE_SIZE = 50;
      ...
      <div style={{position:'fixed',bottom:0,left:0,right:0,background:'#fff',padding:'0.75rem',display:'flex',alignItems:'center',gap:'0.5rem',borderTop:'1px solid #e2e8f0',boxShadow:'0 -4px 6px -1px rgba(0,0,0,0.05)',zIndex:20,flexWrap:'nowrap',overflowX:'auto'}}>
        {selectedKeys.size > 0 ? (
          <>
            ...
            {perms.catalog && selectedKeys.size === 1 && (
          ...
          <>
            ...
            {perms.catalog && <button onClick={()=>setShowImport(true)} style={{...s.btn, padding:'0.4rem 0.75rem', background:'#e0f2fe', color:'#0369a1', border:'none', flexShrink:0}}>
