-- ==============================================================================
-- BẢN CẬP NHẬT 9: SỬA LỖI TRA CỨU TÊN NHÓM DO SAI TÊN CỘT TRONG ZALO_GROUPS
-- ==============================================================================
...
BEGIN
    ...
    -- 🔴 MỚI NHẤT: Tra cứu đúng tên cột group_id và group_name trong bảng zalo_groups của bạn
