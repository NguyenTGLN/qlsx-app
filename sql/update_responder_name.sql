-- 1. Thêm cột responder_name vào bảng
ALTER TABLE public.zalo_conversations ADD COLUMN IF NOT EXISTS responder_name TEXT;

-- 2. Cập nhật lại Trigger để ghi tên nhân viên
    ...
    IF NEW.is_staff = true THEN
        ...
        IF v_target_uid IS NOT NULL THEN
            ...
            SET is_responded = true,
                ...
                responder_name = NEW.sender_name, -- LƯU THÊM TÊN NHÂN VIÊN
                response_ts = NEW.ts,
