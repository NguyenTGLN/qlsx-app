-- ==============================================================================
-- BẢN CẬP NHẬT: SỬA LỖI TIN NHẮN ẢNH BỊ TRỐNG DO ZALO TRẢ VỀ CHUỖI RỖNG ("")
-- ==============================================================================
...
BEGIN
    ...
    -- 3. Nhặt các file đính kèm (Xử lý triệt để trường hợp chuỗi rỗng của Zalo)
    ...
    IF NEW.msg_type = 'chat.sticker.msg' THEN
        NEW.content := '[Sticker]';
    ELSIF NEW.msg_type = 'chat.photo.msg' OR NEW.msg_type = 'chat.image.msg' THEN
    ...
    ELSIF NEW.msg_type = 'chat.voice.msg' THEN
        NEW.content := '[Ghi âm]';
    ELSIF NEW.msg_type = 'chat.file.msg' OR NEW.msg_type = 'chat.link.msg' THEN
