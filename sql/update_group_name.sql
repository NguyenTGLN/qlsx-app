-- 1. Thêm cột group_name vào cả 2 bảng
ALTER TABLE public.zalo_messages ADD COLUMN IF NOT EXISTS group_name TEXT;
ALTER TABLE public.zalo_conversations ADD COLUMN IF NOT EXISTS group_name TEXT;

-- 2. Cập nhật Trigger để lấy group_name từ tin nhắn chuyển sang bảng hội thoại
    ...
    ELSE
        ...
        ELSE
            INSERT INTO public.zalo_conversations (
                ...
                NEW.thread_id, NEW.uid_from, NEW.sender_name, v_is_group, NEW.group_name,
