-- ==============================================================================
-- BẢN CẬP NHẬT: NHẬN DIỆN NHÂN VIÊN TRẢ LỜI DỰA VÀO TÍNH NĂNG "QUOTE/TRẢ LỜI"
-- ==============================================================================
...
BEGIN
    ...
    -- Nếu có Quote 1 ai đó, kiểm tra xem người đó có phải là Khách Hàng đang chờ xử lý không
    ...
    -- NẾU KHÔNG CÓ QUOTE HOẶC QUOTE KHÔNG KHỚP -> ĐÂY LÀ TIN NHẮN CỦA KHÁCH HÀNG (Hoặc NV nhắn suông)
    ELSE
        NEW.is_staff := false;
